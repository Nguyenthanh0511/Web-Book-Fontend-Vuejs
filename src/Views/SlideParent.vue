                        ...
                        <div class="max-w-xl text-center lg:text-left">
                            <div>
                                ...
                                <p class="text-2xl font-bold tracking-tight text-black sm:text-4xl" v-motion-slide-visible-once-bottom>
                                    Mỗi cuốn sách bạn đọc , đó là một phần cuộc đời của người viết là những trải nghiệm quý báu
                                    <br>
                                    Người đọc sách là người sống nhiều cuộc đời
                                </p>
                                <p class="max-w-xl mt-4 text-base tracking-tight text-gray-600" v-motion-slide-visible-once-bottom>
                                Đọc là những bước chân mà bạn đi <br>
                                Đọc để ngao du trong thế giới của bạn <br>
                                Hiểu sâu về thế giới của bạn <br>
                                Rồi mở rộng để hiểu về thế giới quanh bạn
                                </p>
                            </div>
