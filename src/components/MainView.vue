<template>
<div class="contai" style="margin-top:-60px;">
    <div class="row">
        <!-- Logo -->
        <div class="col-lg-4 col-md-6 col-sm-6 col-6">
            <router-link class="navbar-brand" :to="{ name: 'Home' }">
                ...
                <!-- Search Bar -->
        <div class="mt-5 col-lg-4 col-md-6 col-sm-6 col-6">
            <div class="input-group btn-custom">
                ...
                <button type="button" class=" btn btn-outline-primary " style="margin-top: ; height:30px;" data-mdb-ripple-init>Search</button>
            </div>
        </div>
        <!-- Login and Accounts -->
        <div class="mt-4 col-lg-4 col-md-12 col-sm-12 col-12">
            <ul class="nav justify-content-center lg-black mt-3 ">
                <li class="nav-item" style="border: 2px solid blue; border-top-left-radius: 10px; border-bottom-left-radius: 10px; background-color: blue; height: 40px;">
                    <router-link class="nav-link nav-link-custom text-light"  :to="{ name: 'Signup' }">Login</router-link>
                </li>
                <li class="nav-item">
